package com.aplikasihadir.pages.ImportStatus;
...
public class ImportStatusPages {
    ...
    private WebElement alertExcelKosongan;
    ...
    public void setInputFileExcel() throws InterruptedException {
        inputFileExcel.sendKeys("C:\\Users\\Glen adam bararaja\\Downloads\\DATA_STATUS_USER.xlsx");
        Thread.sleep(1000);
    }

    public void setInputFileExcelSalah() throws InterruptedException {
        inputFileExcel.sendKeys("C:\\Users\\Glen adam bararaja\\Downloads\\woman hadir.jpg");
        Thread.sleep(1000);
    }

    public void inputFileExcelKosong() throws  InterruptedException{
        inputFileExcel.sendKeys("C:\\Users\\Glen adam bararaja\\Downloads\\kosongan.xlsx");
        Thread.sleep(1000);
    }
